...
public:
    ...
    // auto write_pieces(Ts&&... pieces) -> asio::awaitable<void>;    // Copy pieces into buffer and reference buffer
    // auto write_ref(std::string_view s) -> asio::awaitable<void>;
...
public:
    ...
    auto error_code() -> std::error_code { return ec_; }
