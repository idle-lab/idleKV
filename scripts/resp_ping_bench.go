...
func parseArgs() (*args, error) {
	...
	fs.IntVar(&a.pipeline, "pipeline", 1, "Number of in-flight PING per round trip per client.")
	...
	fs.Float64Var(&a.duration, "d", 10.0, "Benchmark duration in seconds.")
	fs.Float64Var(&a.warmup, "warmup", 2.0, "Warmup time in seconds.")
	fs.Float64Var(&a.warmup, "w", 2.0, "Warmup time in seconds.")
